...
//            let myUIImageView = UIImage()
//            let color = myUIImageView.findColors(point: point)
...
public extension UIImage {
    ...
    func getPixelColor(pos: CGPoint) -> UIColor? {
     ...
     //   pixelInfo.reserveCapacity(_ minimumCapacity: )
     ...
     func calculateVolume(pos: UIColor, width: Double, height: Double) -> Double{
        ...
        let area = Double(colorPixels)/totalPixels  * (width*height)
               if(ViewController.selectorCount == 0){
                   ...
                   let volumeOfArea = area * (0.0000035)
                   return volumeOfArea;
               }
               
               else if(ViewController.selectorCount == 3){
                   let volumeOfArea = area * (0.000001)
                   return volumeOfArea;
               }
               return 0.0;
    }
    ...
    func isGrey (pos: UIColor) -> Bool {
        ...
        pos.getRed(&red, green: &green, blue: &blue, alpha: &alpha)
        return abs(red-green) < (10/255) &&
            abs(red-blue) < (10/255) &&
            abs(blue-green) < (10/255)
    }
